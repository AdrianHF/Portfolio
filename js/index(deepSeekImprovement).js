...
const wholePageSvg = document.getElementById('wholePageSvg');
const circles1 = document.querySelectorAll('.circle-hover');



if (localStorage.getItem('firstVisit') == 'false') {
  startHere.style.display = 'none';
  wholePageSvg.style.backgroundColor = ' #fcf8ee'
} else {

  wholePageSvg.classList.add('first-visit');

  startHere.style.display = 'block';
  wholePageSvg.style.backgroundColor = '#C4BDAB'; 
}


console.log(localStorage.getItem('firstVisit')); // Debugging line to check first visit status
...
function activateElements() {
  wholePageSvg.style.backgroundColor = ' #fcf8ee'
  wholePageSvg.classList.remove('first-visit');

  startHere.style.display = 'none'; // Hide the start here icon

 localStorage.setItem('firstVisit', 'false'); // Update first visit status
  console.log(localStorage.getItem('firstVisit')); // Debugging line to check first visit status
